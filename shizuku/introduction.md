...
4. (Pie+) Execute the native program `cmd` ([see here](https://android.googlesource.com/platform/frameworks/native/+/pie-release/cmds/cmd/https://android.googlesource.com/platform/frameworks/native/+/pie-release/cmds/cmd/))
...
2. The app interacts with the Shizuku service through the binder, and the Shizuku service process interacts with the system server through the binder.# Introduction
